...
class CustomSlidingSegmentedControl<T> extends StatefulWidget {
  const CustomSlidingSegmentedControl({
    ...
    this.thumbColor1 = CupertinoColors.white,
    this.thumbColor2 = CupertinoColors.white,
    this.thumbColor3 = CupertinoColors.white,
    this.thumbColor4 = CupertinoColors.white,
